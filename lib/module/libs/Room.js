...
export class Room {
          ...
          case GroupCallEventType.ON_ERROR:
            {
              ...
              const participant = additionalData === null || additionalData === void 0 ? void 0 : additionalData.participant;
          ...
          case GroupCallEventType.ON_REMOTE_PARTICIPANT_ENTERED:
            {
              ...
              (_listener$onRemotePar = listener.onRemoteParticipantEntered) === null || _listener$onRemotePar === void 0 ? void 0 : _listener$onRemotePar.call(listener, additionalData === null || additionalData === void 0 ? void 0 : additionalData.participant);
              break;
            }
          ...
          case GroupCallEventType.ON_REMOTE_PARTICIPANT_EXITED:
            {
              ...
              (_listener$onRemotePar2 = listener.onRemoteParticipantExited) === null || _listener$onRemotePar2 === void 0 ? void 0 : _listener$onRemotePar2.call(listener, additionalData === null || additionalData === void 0 ? void 0 : additionalData.participant);
              break;
            }
          ...
          case GroupCallEventType.ON_REMOTE_PARTICIPANT_STREAM_STARTED:
            {
              ...
              (_listener$onRemotePar3 = listener.onRemoteParticipantStreamStarted) === null || _listener$onRemotePar3 === void 0 ? void 0 : _listener$onRemotePar3.call(listener, additionalData === null || additionalData === void 0 ? void 0 : additionalData.participant);
              break;
            }
          ...
          case GroupCallEventType.ON_AUDIO_DEVICE_CHANGED:
            {
              ...
              (_listener$onAudioDevi = listener.onAudioDeviceChanged) === null || _listener$onAudioDevi === void 0 ? void 0 : _listener$onAudioDevi.call(listener, (additionalData === null || additionalData === void 0 ? void 0 : additionalData.currentAudioDevice) ?? null, (additionalData === null || additionalData === void 0 ? void 0 : additionalData.availableAudioDevices) ?? []);
              break;
            }
          ...
          case GroupCallEventType.ON_REMOTE_VIDEO_SETTINGS_CHANGED:
            {
              ...
              (_listener$onRemoteVid = listener.onRemoteVideoSettingsChanged) === null || _listener$onRemoteVid === void 0 ? void 0 : _listener$onRemoteVid.call(listener, additionalData === null || additionalData === void 0 ? void 0 : additionalData.participant);
              break;
            }
          ...
          case GroupCallEventType.ON_REMOTE_AUDIO_SETTINGS_CHANGED:
            {
              ...
              (_listener$onRemoteAud = listener.onRemoteAudioSettingsChanged) === null || _listener$onRemoteAud === void 0 ? void 0 : _listener$onRemoteAud.call(listener, additionalData === null || additionalData === void 0 ? void 0 : additionalData.participant);
              break;
            }
          ...
          case GroupCallEventType.ON_CUSTOM_ITEMS_UPDATED:
            {
              ...
              (_listener$onCustomIte = listener.onCustomItemsUpdated) === null || _listener$onCustomIte === void 0 ? void 0 : _listener$onCustomIte.call(listener, (additionalData === null || additionalData === void 0 ? void 0 : additionalData.updatedKeys) ?? []);
              break;
            }
          ...
          case GroupCallEventType.ON_CUSTOM_ITEMS_DELETED:
            {
              ...
              (_listener$onCustomIte2 = listener.onCustomItemsDeleted) === null || _listener$onCustomIte2 === void 0 ? void 0 : _listener$onCustomIte2.call(listener, (additionalData === null || additionalData === void 0 ? void 0 : additionalData.deletedKeys) ?? []);
              break;
            }
        }
      });
  ...
  _updateInternal(props) {
    this._localParticipant = LocalParticipant.get(this._binder, this._internalEvents, props.localParticipant, this.roomId);
    this._props = props;
    return this;
  }
